...
LL:bind_unit_attr('血条.进度条', '最大值', '最大生命')
LL:bind_unit_attr('血条.文本.当前值', '文本', '生命')
LL:bind_unit_attr('血条.文本.最大值', '文本', '最大生命')
LL:bind_unit_attr('蓝条.进度条', '当前值', '魔法')
LL:bind_unit_attr('蓝条.进度条', '最大值', '最大魔法')
LL:bind_unit_attr('蓝条.文本.当前值', '文本', '魔法')
LL:bind_unit_attr('蓝条.文本.最大值', '文本', '最大魔法')
LL:bind_unit_attr('属性栏.攻击.文本', '文本', '物理攻击')
LL:bind_unit_attr('属性栏.防御.文本', '文本', '物理防御')
LL:bind_unit_attr('属性栏.力量.文本', '文本', '力量')
