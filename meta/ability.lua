...
--设置简易普攻的类型
---@param atk_type integer # 简易普攻类型
function Ability:api_set_simple_attack_type(atk_type) end

--获取简易普攻的类型
---@return integer # 简易普攻类型
function Ability:api_get_simple_attack_type() end

--设置简易普攻的伤害类型
---@param dmg_type integer # 伤害类型
function Ability:api_set_simple_attack_damage_type(dmg_type) end

--获取简易普攻的伤害类型
---@return integer # 伤害类型
function Ability:api_get_simple_attack_damage_type() end

--设置简易普攻的弹道
---@param effect integer # 弹道特效
function Ability:api_set_simple_attack_trajectory_effect(effect) end

--获取简易普攻的弹道
---@return integer # 弹道特效
function Ability:api_get_simple_attack_trajectory_effect() end

--增加技能的筛选单位的tag
---@param tag string # 标签
---@param modify_simple_atk? boolean # 是否修改简易普攻
function Ability:api_add_filter_unit_tag(tag, modify_simple_atk) end

--移除技能的筛选单位的tag
---@param tag string # 标签
---@param modify_simple_atk? boolean # 是否修改简易普攻
---@return string # 标签
function Ability:api_remove_filter_unit_tag(tag, modify_simple_atk) end

--增加技能的筛选物品的tag
---@param tag string # 标签
---@param modify_simple_atk? boolean # 是否修改简易普攻
function Ability:api_add_filter_item_tag(tag, modify_simple_atk) end

--移除技能的筛选物品的tag
---@param tag string # 标签
---@param modify_simple_atk? boolean # 是否修改简易普攻
---@return string # 标签
function Ability:api_remove_filter_item_tag(tag, modify_simple_atk) end

--增加技能的筛选可破坏物的tag
---@param tag string # 标签
---@param modify_simple_atk? boolean # 是否修改简易普攻
function Ability:api_add_collection_destructible_tags(tag, modify_simple_atk) end

--移除技能的筛选可破坏物的tag
---@param tag string # 标签
---@param modify_simple_atk? boolean # 是否修改简易普攻
---@return string # 标签
function Ability:api_remove_collection_destructible_tags(tag, modify_simple_atk) end
